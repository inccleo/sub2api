...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	desktopAuthCodeStore := repository.NewDesktopAuthCodeStore(redisClient)
	desktopAuthService := service.NewDesktopAuthService(configConfig, desktopAuthCodeStore, authService)
	desktopAuthHandler := handler.NewDesktopAuthHandler(desktopAuthService)
	...
	kimiTokenProvider := service.ProvideKimiTokenProvider(accountRepository, geminiTokenCache, kimiOAuthService, oAuthRefreshAPI, tempUnschedCache)
	...
	dailyCheckinService := service.NewDailyCheckinService(dailyCheckinRepository, settingService, apiKeyAuthCacheInvalidator, billingCacheService, client)
	...
	accountTestService := service.ProvideAccountTestService(accountRepository, geminiTokenProvider, claudeTokenProvider, grokTokenProvider, kimiTokenProvider, antigravityGatewayService, httpUpstream, configConfig, tlsFingerprintProfileService, openAIGatewayService, settingService, pluginManager)
	...
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, grokOAuthHandler, kimiOAuthHandler, cnProviderHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, pluginHandler, adminAPIKeyHandler, scheduledTestHandler, channelHandler, channelMonitorHandler, channelMonitorRequestTemplateHandler, contentModerationHandler, promptAdminHandler, paymentHandler, affiliateHandler, complianceHandler, auditLogHandler, upstreamBillingProbeService, ollamaCloudUsageService)
	...
	imageWorkbenchHandler := handler.ProvideImageWorkbenchHandler(apiKeyService, apiKeyAuthMiddleware, asyncImageHandler, configConfig, accountRepository)
