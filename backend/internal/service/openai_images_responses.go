...
func (s *OpenAIGatewayService) forwardOpenAIImagesOAuth(
	...
	if direct {
		responsesBody, targetURL, err = buildOpenAIImagesOAuthPayload(resolvedParsed, upstreamModel)
	} else {
		responsesBody, err = buildOpenAIImagesResponsesRequest(resolvedParsed, upstreamModel)
