<template>
  ...
  >
    ...
    >
      ...
      <div>
        ...
        <div class="mt-2 flex flex-wrap rounded-lg bg-gray-100 p-1 dark:bg-dark-700">
          <button
            ...
            :class="[
              'flex flex-1 items-center justify-center gap-2 rounded-md px-4 py-2.5 text-sm font-medium transition-all',
              form.platform === 'kimi' && form.type === 'apikey'
          ...
          <button
            type="button"
            @click="selectKimiOAuth"
            :class="[
              'flex flex-1 items-center justify-center gap-2 rounded-md px-4 py-2.5 text-sm font-medium transition-all',
              form.platform === 'kimi' && form.type === 'oauth'
                ? 'bg-white text-sky-600 shadow-sm dark:bg-dark-600 dark:text-sky-400'
                : 'text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-200'
            ]"
          >
            <PlatformIcon platform="kimi" size="sm" />
            {{ t('admin.accounts.types.kimiOauth') }}
          </button>
        </div>
      </div>
      ...
      <div v-if="isCNPlatform && form.type === 'apikey'">
      ...
      <div v-if="isCNPlatform && form.type === 'apikey'" class="mt-4">
