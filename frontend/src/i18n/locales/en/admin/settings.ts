export default {
    settings: {
      ...
      site: {
        ...
        remove: 'Remove',
        logoHint: 'PNG, JPG, or SVG. Max 300KB. Recommended: a compact wordmark around 5:1, such as 600×120px.',
      ...
      payment: {
        ...
        enterpriseQRCode: 'Enterprise Contact QR Code',
        enterpriseQRCodePlaceholder: 'Upload a WeChat or sales contact QR code',
        enterpriseQRCodeHint: 'Shown in a dialog when users click Contact Sales on the purchase page.',
