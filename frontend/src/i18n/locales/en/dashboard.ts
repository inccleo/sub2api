export default {
  ...
  modelPlaza: {
    ...
    table: {
      ...
      cacheWrite: 'Write',
      cacheRead: 'Read',
      paidPrice: 'Equivalent Price',
      officialPrice: 'Official Price',
      rate: 'Effective Discount',
      exchangeNote: '¥1 = $1 credit, converted at {rate} CNY/USD',
      unitPerMillion: '$ / 1M tokens',
  ...
  profile: {
    ...
    dailyCheckin: {
      ...
      rewardDescription: 'Claim {daily} every day and earn an extra {bonus} for each 7-day streak',
      streak: '{count}-day streak',
      daysUntilBonus: '{count} more days until the bonus',
      todayReward: 'Claimed {amount} today',
      action: 'Check in',
      checkedIn: 'Checked in today',
      checkedInWithStreak: 'Checked in · {count}d',
      openHint: 'Click to view check-in calendar',
      completed: 'Completed',
      ...
      historyLoadFailed: 'Failed to load check-in history',
      baseReward: 'Base {amount}',
      bonusIncluded: 'includes streak bonus {amount}',
      prevMonth: 'Previous month',
      nextMonth: 'Next month',
      legendChecked: 'Claimed',
      legendBonus: 'Bonus',
      legendFuture: 'Upcoming',
      legendToday: 'Today',
      projectedReward: 'Est. {amount}',
      missed: 'Missed',
    },
