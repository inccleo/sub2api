export default {
  ...
  payment: {
    ...
    moreRechargeMoreBonus: 'Top up more, get a bigger bonus',
    rechargeAmount: 'Top-up amount',
    selectQuickAmount: 'Select {amount} top-up',
    bonusAmount: 'Bonus {amount}',
    creditedAmount: 'Receive {amount}',
    noBonusStarter: 'Flexible starter amount',
    bestValue: 'Best value',
    popularChoice: 'Popular',
    rechargeBonus: 'Package bonus',
    packageNames: {
      trial: 'Trial',
      standard: 'Standard',
      advanced: 'Advanced',
    ...
    packageDescriptions: {
      trial: 'For a first experience',
      standard: 'For light daily use',
      advanced: 'For frequent use',
      professional: 'For professional developers',
    },
    enterpriseBadge: 'Volume pricing',
    enterpriseCooperation: 'Enterprise cooperation',
    enterpriseDescription: 'Contact us for volume top-ups, team usage, or a tailored plan.',
    contactEnterprise: 'Contact sales',
    enterpriseContactHint: 'The enterprise contact QR code has not been configured',
    enterpriseDialogTitle: 'Scan to contact sales',
    enterpriseDialogDescription: 'Connect with our sales team for volume top-ups, team usage, and tailored plans.',
    enterpriseQRCodeAlt: 'Enterprise contact QR code',
    enterpriseScanHint: 'Scan with WeChat or the corresponding app',
