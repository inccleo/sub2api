export default {
    settings: {
      ...
      site: {
        ...
        uploadImage: '上传图片',
        remove: '移除',
        logoHint: 'PNG、JPG 或 SVG 格式，最大 300KB。建议使用约 5:1 的紧凑横版字标，例如 600×120px。',
      ...
      payment: {
        ...
        enterpriseQRCode: '企业合作二维码',
        enterpriseQRCodePlaceholder: '上传微信、企微或商务联系二维码',
        enterpriseQRCodeHint: '用户在充值页面点击“联系商务”后，将在弹窗中看到此二维码。',
        providerEasypay: '易支付',
