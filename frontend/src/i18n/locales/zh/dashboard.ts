export default {
  ...
  modelPlaza: {
    ...
    table: {
      ...
      officialPrice: '官方价格',
      rate: '综合折扣',
      exchangeNote: '¥1 = $1 额度，按汇率 {rate} 折算',
      unitPerMillion: '$ / 1M token',
      perUnitRequest: '/ 次',
      perUnitImage: '/ 张',
      perRequest: '按次计费',
  ...
  profile: {
    ...
    dailyCheckin: {
      title: '每日签到',
      rewardDescription: '每天领取 {daily}，连续签到每 7 天额外领取 {bonus}',
      streak: '已连续签到 {count} 天',
      daysUntilBonus: '再签到 {count} 天获得额外奖励',
      todayReward: '今日已领取 {amount}',
      action: '立即签到',
      checkedIn: '今日已签到',
      checkedInWithStreak: '已签到 · {count} 天',
      openHint: '点击查看签到日历',
      completed: '已完成',
      ...
      historyTitle: '签到记录',
      historyEmpty: '暂无签到记录',
      historyLoadFailed: '签到记录加载失败',
      baseReward: '基础 {amount}',
      bonusIncluded: '含连续奖励 {amount}',
      prevMonth: '上个月',
      nextMonth: '下个月',
      legendChecked: '已领',
      legendBonus: '连奖',
