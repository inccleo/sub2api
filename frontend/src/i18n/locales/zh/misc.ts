export default {
  ...
  payment: {
    ...
    quickAmounts: '快捷金额',
    moreRechargeMoreBonus: '充得越多，送得越多',
    rechargeAmount: '充值金额',
    selectQuickAmount: '选择充值 {amount}',
    bonusAmount: '赠送 {amount}',
    creditedAmount: '到账 {amount}',
    noBonusStarter: '灵活体验，按需充值',
    bestValue: '最高优惠',
    popularChoice: '热门推荐',
    rechargeBonus: '档位赠送',
    packageNames: {
    ...
    enterpriseBadge: '大额专享',
    enterpriseCooperation: '企业合作',
    enterpriseDescription: '大额充值、团队用量或定制方案，可联系商务获取专属优惠。',
    contactEnterprise: '联系商务',
    enterpriseContactHint: '管理员暂未配置企业合作二维码',
    enterpriseDialogTitle: '扫码联系商务',
    enterpriseDialogDescription: '添加商务顾问，获取大额充值、团队用量和定制方案。',
    enterpriseQRCodeAlt: '企业合作联系二维码',
    enterpriseScanHint: '请使用微信或对应应用扫码',
    customAmount: '自定义金额',
    enterAmount: '输入金额',
    paymentMethod: '支付方式',
    fee: '手续费',
